...
export default function OldScreen({ navigation }) {
    // "category"가 "OldScreen"인 캐릭터 필터링
    const filteredCharacters = characters.filter((character) => character.category === "OldScreen");
    ...
    <View style={styles.container}>
      ...
      {/* 하단 고정 카테고리 버튼 */}
        <View style={styles.footer}>
            ...
            <Text style={styles.footerClickedButtonText}>유명인</Text>
            </TouchableOpacity>
